<!-- filepath: c:\xampp\htdocs\UrbanStyle\resources\views\purchase_returns\create.blade.php -->
@extends('layouts.app')
...
<div class="container mx-auto p-6 bg-white shadow-md rounded-lg">
    <h1 class="text-2xl font-bold mb-4">Create Purchase Return</h1>

    <form action="{{ route('purchase_returns.store') }}" method="POST" x-data="{
        items: [],
        ...
        <div class="form-group mb-4">
            ...
            <input type="date" name="return_date" id="return_date" class="form-control mt-1 block w-full" required>
        </div>
                ...
                <template x-for="(item, index) in items" :key="index">
                    <tr>
                        ...
                        <td class="p-2 border">
                            ...
                            <input type="hidden" :name="`items[${index}][total_amount]`" x-bind:value="calculateTotalAmount(item)">
        ...
        <!-- Submit Button -->
        <div class="mt-6">
            <button type="submit" class="bg-gray-800 text-white px-4 py-2 rounded">Create Purchase Return</button>
