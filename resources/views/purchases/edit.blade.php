...
<div class="container mx-auto p-6 bg-white shadow-md rounded-lg">
    ...
    <form action="{{ route('purchases.update', $purchaseInvoice->id) }}" method="POST" x-data="{
        items: {{ $purchaseInvoice->purchaseInvoiceItems->map(function($item) {
            return [
        ...
        globalDiscount: {{ $purchaseInvoice->global_discount }},
